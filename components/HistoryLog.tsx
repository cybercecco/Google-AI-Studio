...
import { Trash2, Copy, Check, Clock, Hash, Shield, Unlock, FileText, Info, RefreshCw, UserCircle } from 'lucide-react';
...
const HistoryLog: React.FC<Props> = ({ lang }) => {
  ...
  const handleClear = async () => {
    const confirmMsg = lang === 'it' ? 'Sei sicuro di voler cancellare tutto dal server? Non si può tornare indietro.' : 'Are you sure you want to clear all history from server? This cannot be undone.';
